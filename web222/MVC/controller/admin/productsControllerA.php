...
class productsControllerA
{
    ...
    public function run() {
        ...
        switch ($action) {
            case 'admin_shop':   $this->shopPage(); break;
            case 'admin_create': $this->create(); break;
            case 'admin_edit':   $this->edit(); break;
            case 'admin_store':  $this->store(); break;
            case 'admin_delete': $this->delete(); break;
            default:             $this->shopPage(); break;
        }
    }
