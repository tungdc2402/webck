                                    ...
                                    <div class="col-2">
                                        <div class="woocommerce-shipping-fields">
                                            <h3 id="ship-to-different-address">
                                                <label class="checkbox" for="ship-to-different-address-checkbox">Ship to a backup address?</label>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td class="product-name">
                                                    <strong class="product-quantity">Gigabyte AORUS Z890 × 1</strong>
                                                </td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-total">
                                                    <span class="amount"><b>$400.00</b></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>VAT</th>
                                                <td><span class="amount"><b>$20.00</b></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount">$420.00</span></strong> </td>
                                            </tr>
