...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <!-- Thay toàn bộ dòng link Bootstrap cũ bằng dòng này -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="my_account.html"><i class="fa fa-user"></i> My Account</a></li> <!-- filter -->
                            <li><a href="404.html"><i class="fa fa-heart"></i> Wishlist</a></li> <!-- filter -->
    ...
    <div class="site-branding-area1">
        <div class="container1">
            ...
            <div class="auth-buttons">
               ...
               <a href="register.html" class="btn-auth btn-register">Đăng ký</a>
            </div>
            </div>
		</div>
